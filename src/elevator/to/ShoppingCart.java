...
{ private List ownerList;
  ...
  public void removeOwner(String key) throws Exception
  {
    ...
    DfbsOwner owner = (DfbsOwner) ownerMap.get(key);
    this.setAmount(this.getAmount()-owner.getAmount());
    this.setTotalPermits(this.getTotalPermits()-owner.getElevatorsMapCount());
...
public void setReceiptId(int receiptId)
  ...
  public void setOwnerList(List ownerList)
  {
   ...
   public void setAppRunningCount(int appRunningCount)
  {
