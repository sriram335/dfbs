...
public class HazmatPermitViewForm  extends CompleteContactForm
{  private String orgName;
    ...
    public String toString() {
        return "HazmatPermitViewForm{" +
                ...
                ", shipRadLevel='" + shipRadLevel + '\'' +
                ", shipPermitNumber='" + shipPermitNumber + '\'' +
                ", shipDate='" + shipDate + '\'' +
                ", shipIssueDate='" + shipIssueDate + '\'' +
                ", shipExpDate='" + shipExpDate + '\'' +
