  ...
  throws IOException, ServletException
  {
      ...
      ApplicationSecurityDAO sDAO = (ApplicationSecurityDAO) dmap2.getHsDAO(DfbsDataMap.DFBS_SECURITY);
        ...
        HttpSession session = request.getSession();
           ApplicationContacts contacts = sDAO.setContacts("FIRE_BLDG_EDU_CONTACT1","FIRE_BLDG_EDU_CONTACT2");
          session.setAttribute("APPLICATION_CONTACTS",contacts);
          
        if (method == null ) 
        {   String conType ="FIRE_BLDG_EDU_CONTACT";
            session.setAttribute("APPLICATION_CONTACT_TYPE",conType); 
            String appLocation ="/dfbs/FireBldEducation/start.do";
             session.setAttribute("APPLICATION_LOCATION",appLocation); 
             String appHeading ="Fire and Building Code Education Online Application ";
            ...
            if (security !=null)
         {
             ...
             redirectUrl.append(request.getContextPath()).append("/fireBldEducation/course.do?method=courseAdmin");
          ...
          {             String oldPwdSQL = FireBldEducationSQL.CODE_EDU_CHANGE_PASSWORD_DFBS;
