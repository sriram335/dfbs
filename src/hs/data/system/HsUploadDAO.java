...
public class HsUploadDAO extends HsDAO {
    public HsUploadDAO() {
        super();
    }

    public HsUploadDAO(HsDataSource pool) {
        super(pool);
    }
    ...
    public HsUpload select(String sql, int id) throws Exception {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                upload.setCreatedBy(rs.getString(5));
                upload.setCreatedDate(rs.getDate(6));                              
