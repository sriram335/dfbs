...
public class CodeEducationUserDAO extends HsDAO{
    public CodeEducationUserDAO() {
    }
    ...
    public CodeEducationUser selectUser(int userId) throws SQLException, Exception 
    {
       CodeEducationUser codeUser = new CodeEducationUser();
      Connection conn = null;
    ...
    public CodeEducationUser selectUser(Connection conn,int userId) throws SQLException, Exception 
      {
        CodeEducationUser codeUser = new CodeEducationUser();
        ResultSet rs = null;
        PreparedStatement pstmt = null;
         ...
         try 
        {
          pstmt = conn.prepareStatement(CodeEducationSQL.SELECT_CODE_USER_BY_ID);
          pstmt.clearParameters();
    ...
    public void updateUser(CodeEducationUser codeUser) throws SQLException, Exception 
     {
             Connection conn = null;
             PreparedStatement pstmt = null;
          try 
       {
             ...
             pstmt = conn.prepareStatement(CodeEducationSQL.UPDATE_CODE_USER_BY_ID);
             pstmt.clearParameters();
           ...
           pstmt.setInt(15,codeUser.getUserPersonId());
      ...
      public void insertUser(CodeEducationUser codeUser) throws SQLException, Exception 
     {
          ...
          try 
       {
             ...
             int id = this.getId(conn,"select code_edu_user_id.nextval from dual");
                 pstmt = conn.prepareStatement(CodeEducationSQL.INSERT_CODE_USER);
    ...
    public CodeEducationUser selectUser(String userId) throws SQLException, Exception 
      {
        CodeEducationUser codeUser = new CodeEducationUser();
        ResultSet rs = null;
        PreparedStatement pstmt = null;
         ...
         try 
        { conn = getConnection();
          pstmt = conn.prepareStatement(CodeEducationSQL.SELECT_CODE_USER_BY_USER_ID);
          pstmt.clearParameters();
    ...
    public void updateUserPasswords() throws SQLException, Exception 
     {
          ...
          try 
       {
             conn = getConnection();
             conn.setAutoCommit(true);
             pstmt = conn.prepareStatement(CodeEducationSQL.CODE_EDU_UPDATE_PASSWORDS);
             pstmt.clearParameters();
    ...
    public List selectUserListByName( String userLastName,String userFirstName) throws SQLException, Exception 
    {
      ...
      try 
      {
        ...
        conn = getConnection();
        pstmt = conn.prepareStatement(CodeEducationSQL.SELECT_CODE_USERS_BY_NAME);
        pstmt.clearParameters();
          pstmt.clearParameters();
   ...
   /* public int selectCodeSuperUser(String userId) throws SQLException, Exception 
      {
        ...
        {
            conn = getConnection();
          pstmt = conn.prepareStatement(CodeEducationSQL.CODE_EDU_SUPER_USER);
    ...
    public List selectClassList(int codePersonId) throws SQLException, Exception 
    {
      ...
      try 
      {
        ...
        pstmt = conn.prepareStatement(CodeEducationSQL.SELECT_CODE_COURSE_LIST_PERSON);
          pstmt.clearParameters();
    ...
    public CodeEducationUser selectUser(CodeEducationUser codeUser,String userId,String pwd) throws SQLException, Exception 
      {
         ResultSet rs = null;
        PreparedStatement pstmt = null;
          Connection conn = null;
         ...
         try 
        { conn = getConnection();
          pstmt = conn.prepareStatement(CodeEducationSQL.SELECT_CODE_USER_BY_USER_ID_PWD);
           pstmt.clearParameters();
          pstmt.setString(1,userId);
    ...
    public void  updatePassword(CodeEducationUser codeUser,String newPassword) throws SQLException, Exception
    { 
      Connection conn = null;
      PreparedStatement pstmt = null;
      try 
      {  
        ...
        pstmt = conn.prepareStatement(CodeEducationSQL.CODE_EDU_CHANGE_PASSWORD);
        pstmt.clearParameters();
    ...
    public int selectUserCheck(String userId) throws SQLException, Exception 
      {
        ...
        PreparedStatement pstmt = null;
         ...
         try 
        {conn = getConnection();
          pstmt = conn.prepareStatement(CodeEducationSQL.SELECT_CODE_USER_CHECK);
          pstmt.clearParameters();
          pstmt.setString(1,userId);
          rs = pstmt.executeQuery();
    ...
    public List selectUserListByLastName( String userLastName) throws SQLException, Exception 
    {
      ...
      try 
      {
        ...
        conn = getConnection();
        pstmt = conn.prepareStatement(CodeEducationSQL.SELECT_CODE_USERS +" WHERE UPPER(USER_LAST_NAME)=UPPER(?)");
        pstmt.clearParameters();
          pstmt.clearParameters();
            pstmt.setString(1,userLastName);
