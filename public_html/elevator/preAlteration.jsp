...
<table cellspacing="0" class="noBorder" summary="OWNER DATA">
    ...
    <c:if test="${sessionScope.ELEVATOR_APP_ACTION =='Alteration' }">  
    <html:form action="/elevator" method="post">
      <input type="hidden" name="method" id="METHOD_KEY" value="updateUserInfo"/> 
   <tr>
      <th scope="row" >elevator user name:</th>
      <td>
       <html:text property="locUserName" size="50" maxlength="65"/>
      </td>
    </tr>
     <tr>
      <th scope="row" >elevator user phone:</th>
      <td>
       <html:text property="locUserPhone" size="10" maxlength="10"/>
      </td>
    </tr>
     <tr>
      <th scope="row" >elevator user email:</th>
      <td>
       <html:text property="locUserEmail" size="50" maxlength="100"/>
      </td>
    </tr>
  <tr>
  <th></th>
  ...
  <html:submit value="update " styleClass="button"/>
     ...
     <c:if test="${sessionScope.ELEVATOR_APP_ACTION =='updateUserInfo' }">  
   <html:form action="/application" method="post">
      <input type="hidden" name="method" id="METHOD_KEY" value="applySaveAlteration"/> 
    <%--   <tr>
     <p class="messageBox">
      <b><u> AFFIRMATION OF THE OWNER </u></b></br></br>
      ...
      a fine up to $10,000.</br></br>
       <input type="checkbox" name="ownerAgree" class="switch" value="Y"/>I agree
       </p> --%>
       </tr>
       <tr>
  ...
  <%--   <tr>
       <p class="messageBox">
      <b><u> AFFIRMATION OF THE CONTRACTOR </u></b></br></br>
      ...
      a fine up to $10,000.</br></br>
       <input type="checkbox" name="contractorAgree" class="switch" value="Y"/>I agree
       </p>
       </tr> --%>
     <tr>
