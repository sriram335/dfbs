...
Elevator Contractor: <c:out value="${sessionScope.SERVICE_CONTRACTOR_SELECTED.contLastName}"/>,<c:out value="${sessionScope.SERVICE_CONTRACTOR_SELECTED.contFirstName}"/>&nbsp; <br/> 
<a   href="/dfbs/elevator/servContractor.do?method=backToContractor">
              [back to contractor]</a></br>  
<div id="leftContentFluid">
<html:form action="/servContractor" method="post" enctype="multipart/form-data">
 ...
 <input type="hidden" name="method" id="METHOD_KEY" value="backToContractor"/>
 
        <input type="submit" value="Upload Complete back to Checkout" class="button"/>
</html:form>
