...
<html:form action="/elevator" method="post" enctype="multipart/form-data">
  ...
  <input type="hidden" name="method" id="METHOD_KEY" value="uploadTestFile"/>
 <p class="message" size="125" align="left">
   ...
   <p  align="left">
  <b>State Number:</b><html:text property="stateNumber" size="12" maxlength="12"/> </br>
  <b>User Email:</b><html:text property="locUserEmail" size="50" maxlength="50"/> </br>
  (Test approval by IDHS will be emailed to this user)</br>
   <c:if test="${sessionScope.STATE_NUMBER_ERROR == 'ERROR'}"> 
      <span class="error">ERROR !. Please Enter State Number</span>
      </c:if>   
     <c:if test="${sessionScope.USER_EMAIL_ERROR == 'ERROR'}"> 
      <span class="error">ERROR !.Please Enter User Email</span>
       ...
       <td width="100%" align="left" valign="middle"> 
        ...
        <input type="submit" value="Upload Test Report" class="button"/>
