...
<div id="sideContentFluid">
 ...
 <a   href="/dfbs/elevator/servContractor.do">
             [back to start]</a>  
<div>
 <h2>Update Elevator Service Contractor</h2> 
 <html:form action="/servContractor" method="post">
      <input type="hidden" name="method" id="METHOD_KEY" value="saveUpdateRenewal"/> 
         <html:hidden property="contId"/> 
         <html:hidden property="licNumber"/> 
         <html:hidden property="contType"/> 
         <html:hidden property="contFirstName"/> 
         <html:hidden property="contLastName"/> 
         <html:hidden property="contMI"/> 
...
<table cellspacing="0" class="noBorder" summary="OWNER DATA">
    ...
    <th style="color:rgb(198,198,198)" >__________________________</th>
     ...
     <tr>
      ...
      <td>
        <c:out value="${sessionScope.SERVICE_CONTRACTOR_SELECTED.contFirstName}"/>
       </td>
      </tr>
    <tr> 
     <tr>
      ...
      <td>
        <c:out value="${sessionScope.SERVICE_CONTRACTOR_SELECTED.contLastName}"/>
       </td>
      </tr>
    <tr> 
     <tr>
      ...
      <td>
        <c:out value="${sessionScope.SERVICE_CONTRACTOR_SELECTED.contMI}"/>
       </td>
      </tr>
    <tr> 
     <tr>
      ...
      <td>
         <c:out value="${sessionScope.SERVICE_CONTRACTOR_SELECTED.licNumber}"/>
       </td>
      </tr>
    <tr> 
     <tr>
      ...
      <td>
         <c:out value="${sessionScope.SERVICE_CONTRACTOR_SELECTED.contType}"/>
       </td>
      </tr>
    <tr> 
     <tr>
      ...
      <td>
         <c:out value="${sessionScope.SERVICE_CONTRACTOR_SELECTED.contIssueDateString}"/>
       </td>
      </tr>
    <tr> 
    <tr>
      <th scope="row">Expiation Date:</th>
      <td>
         <c:out value="${sessionScope.SERVICE_CONTRACTOR_SELECTED.contExpDateString}"/>
       </td>
      </tr>
    <tr> 
  <tr>
