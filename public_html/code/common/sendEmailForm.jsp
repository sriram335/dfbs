...
<hs:control/>
<html:xhtml/>
<c:set var="module" scope="request" value="IDHS - Code Enforcement Division"/>
...
<div id="mainBox">
  ...
  <html:link page="/main.do" >back to home</html:link>
  ...
  <div id="mainContentFluid" align="left">
    ...
    <form method="post" action="/dfbs/code/main.do">
      <p>
