...
<div id="mainBox">
  ...
  <c:if test="${OWNER_AFFIRMATION_ERROR =='N'}">
  <html:form action="/start" method="post">
      <input type="hidden" name="method" id="METHOD_KEY" value="ownerVerified"/>  
...
<table cellspacing="0" class="noBorder" summary="OWNER DATA">
    ...
    <th style="color:rgb(198,198,198)" >__________________________</th>
     ...
     2. I am the owner or I am an authorized person to submit the variance on owner behalf.</b>
   ...
   <c:if test="${OWNER_AFFIRMATION_ERROR =='Y'}">
