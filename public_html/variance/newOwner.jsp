...
<h3>Applicant Information(Person who would be in violation if variance is not granted;usually this is the owner)</h3> 
...
<table cellspacing="0" class="noBorder" summary="OWNER DATA">
    ...
    <th style="color:rgb(198,198,198)" >__________________________</th>
        ...
        <tr>
          <th scope="row"   class="required"   > * applicant last name:</th>
          <td>
         ...
         <tr>
         <th scope="row"   class="required"   > * applicant first name:</th>
         <td>
         ...
         <tr>
          <th scope="row"     > applicant organization name:</th>
          <td>
