...
<html:form action="/start" method="post" >
 ...
 <table cellspacing="0" class="noBorder" summary="OWNER FORM">
    ...
    <tr>
     ...
     <tr>
      <th class="required"> * Is this project State Owned?  </th>
      <td >
     ...
     <tr>
      <th class="required"> * Is this project in City Limits?  </th>
      <td >
    ...
    <tr>
      <th class="required"> * Is this variance application related to to a regulated lifting device  </th>
      <td >
            <html:select property="varAppLboName" >
              ...
              <br/><span class="error">* please select related to a regulated lifting device  </span> 
            </c:if>
      </td>
    </tr>
     <tr>
