...
<div id="mainBox">
  ...
  <h1><b><u>View Designer</u></b></h1></br> </br> 
<h2>Design Professional of Record</h2> 

  <div class="styledBox">
 <html:form action="/designer" method="post">
      <input type="hidden" name="method" id="METHOD_KEY" value="updateDesigner"/> 
...
<table cellspacing="0" class="noBorder" summary="OWNER DATA">
    ...
    <th style="color:rgb(198,198,198)" >__________________________</th>
        ...
        <tr>
         ...
         <tr>
          <th scope="row"    class="required"  > design professional firm name:</th>
          <td>
