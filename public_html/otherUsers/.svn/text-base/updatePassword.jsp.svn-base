...
<div id="mainBox">
 ...
 <a   href="/dfbs/otherUsers/otherUser.do">
              [back to start]</a>  
 ...
 <tr>
      ...
      <td>
        ...
        <c:if test="${OTHER_USER_ERROR.userPassword == 'ERROR_SAMEPASSWORD'}">
          <br/>
          <span class="error">* you can not use the same password as old</span> 
        </c:if>
         <c:if test="${OTHER_USER_ERROR.userPassword == 'ERROR_NOTOLDPASSWORD'}">
          <br/>
   ...
   <tr>
      ...
      <td>
        ...
        <c:if test="${CIG_USER_ERROR.userPassword == 'ERROR_LENGTH'}">
          <br/>
     ...
     <tr>
      ...
      <td>
        ...
        <c:if test="${OTHER_USER_ERROR.userPassword == 'ERROR_NOTEQUAL'}">
          <br/>
...
<td>
 <c:if test="${OTHER_USER.userId == 'ERROR'}">
          <br/>
          <span class="error">* user email does not match with data in database contact rulikal@dhs.in.gov with details</span> 
</c:if>
 </td>
</tr> 
  </tbody>
