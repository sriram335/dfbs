...
<div id="mainBox">
 ...
 <a   href="/dfbs/otherUsers/otherUser.do?method=userList">
              [back to start]</a>  
...
<c:url var="url" value="/otherUsers/otherUser.do?method=filter&filter=byLetter&letter=${c.character}" />
...
<c:if test="${sessionScope.DFBS_SECURITY.groupLevelAll != null   || sessionScope.DFBS_SECURITY.groupLevelPlan == 'SUPERVISOR' ||sessionScope.DFBS_SECURITY.groupLevelPlan == 'USER'}">   
<a   href="/dfbs/otherUsers/otherUser.do?method=updateLepcUser&userId=<c:out value="${user.userId}"/>">[Edit User Information]</a>
