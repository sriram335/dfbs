...
<div id="mainBox">
<a   href="/dfbs/otherUsers/otherUser.do?method=userListEms">
              back</a></br>

  <div class="styledBox">
 <div id="mainContentFluid" align="left">
 
  <h2>Add / Update  EMS User Acccount  </h2> 
 <html:form action="/otherUser" method="post">
      <input type="hidden" name="method" id="METHOD_KEY2" value="saveEmsUser"/> 
