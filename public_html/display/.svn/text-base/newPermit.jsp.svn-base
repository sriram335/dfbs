...
2.Add display date(s).</br>
3.Add permit to Shopping cart</br>
...
<%--<c:if test="${sessionScope.DFBS_SECURITY.groupLevelAll != null   || sessionScope.DFBS_SECURITY.groupLevelFire != null }">  
    ...
    <tr>
     ...
     <tr>
          ...
          <td>
           <html:text property="displayAddress1" size="30" maxlength="30"/>
                 <c:if test="${PERMIT_ERROR.displayAddress1 == 'ERROR'}">
     ...
     <tr>
          ...
          <td>
           <html:text property="displayAddress2" size="30" maxlength="30"/>
      ...
      <tr>
          ...
          <td>
           <html:text property="displayCity" size="30" maxlength="30"/>
                 <c:if test="${PERMIT_ERROR.displayCity == 'ERROR'}">
   ...
   <tr>
      ...
      <td>
          <html:select property="displayState" styleId="SELECT_INITIAL" onchange="setSelectValue('SELECT_INITIAL','STATE_INTITIAL')">
          <html:option value="IN">INDIANA</html:option>
          <html:options collection="DISPLAY_STATE_OPTIONS" property="value" labelProperty="label"/>
        </html:select>
        <c:if test="${PERMIT_ERROR.displayState == 'ERROR'}">
        ...
        <tr>
          ...
          <td>
           <html:text property="displayZip" size="5" maxlength="5"/>
                 <c:if test="${PERMIT_ERROR.displayZip == 'ERROR'}">
    ...
    <tr>
      ...
      <td>
          <html:select property="displayFd" styleId="SELECT_ID" onchange="setSelectValue('SELECT_ID','DEPARTMENT_ID')">
          <html:option value="">Please Select</html:option>
          <html:options collection="FIRE_DEPT_OPTIONS" property="value" labelProperty="label"/>
        </html:select>
        <c:if test="${PERMIT_ERROR.displayFd == 'ERROR'}">
     ...
     <tr>
      ...
      <tr>
        ...
        <p>
          <html:submit value=" Add to the shopping cart " styleClass="button"/></br>
     <%--     display dates:
