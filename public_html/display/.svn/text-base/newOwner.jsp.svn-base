...
<div id="sideContentFluid">
 ...
 <html:form action="/ownerListDisplay" method="post">
      <input type="hidden" name="method" id="METHOD_KEY" value="newPermit"/> 
...
<table cellspacing="0" class="noBorder" summary="OWNER DATA">
    ...
    <th style="color:rgb(198,198,198)" >__________________________</th>
        ...
        <tr>
          ...
          <td>
           <html:text property="ownerLastName" size="80" maxlength="80"/>
        ...
        <tr>
          ...
          <td>
           <html:text property="ownerAddress2" size="80" maxlength="80"/>
          </td> 
          </th>
        </tr>
         <tr>
        ...
        <tr>
         <th scope="row"  class="required"   >* email:</th>
          ...
          <c:if test="${OWNER_ERROR.ownerEmail == 'ERROR'}">
              <br/><span class="error">* please enter email in correct format name@company.ext  </span> 
            </c:if>
        </tr>
        <tr>
     <th scope="row"     > </th>
