...
<a   href="/dfbs//childCare/childcare.do?method=renewPermit&permitKey=<c:out value="${PERMIT_SELECTED.permitNumber}"/>">
              [back to owner]</a>
<div id="leftContentFluid">
  <div class="styledBox">
 <html:form action="/contact" method="post">
      <input type="hidden" name="method" id="METHOD_KEY" value="saveEditContact"/> 
