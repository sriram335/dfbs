...
<jsp:include page="/app/common/hsPageHeader.jsp"/>
 <a   href="/dfbs/childCare/inspection.do?method=inspectionList&permitNumber=<c:out value="${sessionScope.VIEW_PERMIT_SELECTED.permitNumber}"/>">
...
<div id="rightContentFluid">
 <p class="control2">
  ...
  <tr>
    ...
    <tr>
        <th scope="row" >intended occupant load:</th>
        <td>
