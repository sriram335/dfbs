...
<c:set var="title" scope="request" value="Application for Annual / Special Entertaiment Permits"/>
    ...
    <c:choose>
      <c:when test="${requestScope.DFBS_APPLICATION == 'NEW'}">
        <div class="messageBox">
          <h3>Important:</h3>
          <p>If You are a Applying for a
            <span style="font-size:x-large;font-weight:bold;"> New </span> Entertainment Permit for a new location...
          </p>
