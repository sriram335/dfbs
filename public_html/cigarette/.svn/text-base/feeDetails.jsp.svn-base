...
<hs:control/>
Application Id : <c:out value="${sessionScope.CIGARETTE_APPROVE_APPLICATION.appId}"/>
 <c:forEach var="fee" items="${sessionScope.CIGARETTE_APPROVE_APPLICATION.appFees}" varStatus="i">
