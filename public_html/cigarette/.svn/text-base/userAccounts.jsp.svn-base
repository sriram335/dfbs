...
<div id="mainBox">
 ...
 <html:form action="/cigUser" method="post">
      <input type="hidden" name="method" id="METHOD_KEY" value="manageAccounts"/>
...
<td>
  ...
  <p class="message" >If you have forgotten your password enter your user id in user id box and click forgot password link.
