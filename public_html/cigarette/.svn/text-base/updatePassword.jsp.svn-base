...
<div id="mainBox">
 ...
 <a   href="/dfbs/cigarette/cigarette.do">
              [back to start]</a>  
 <a   href="/dfbs/cigarette/cigUser.do?method=manageAccounts">
              [back user accounts]</a>  
 ...
 <tr>
      ...
      <td>
        ...
        <c:if test="${CIG_USER_ERROR.userPassword == 'ERROR_SAMEPASSWORD'}">
          <br/>
          <span class="error">* you can not use the same password as old</span> 
        </c:if>
         <c:if test="${CIG_USER_ERROR.userPassword == 'ERROR_NOTOLDPASSWORD'}">
          <br/>
   ...
   <tr>
     ...
     <tr>
      ...
      <td>
        ...
        <c:if test="${CIG_USER_ERROR.userPassword == 'ERROR_NOTEQUAL'}">
          <br/>
