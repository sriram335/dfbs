...
<c:url var="url" value="/cigarette/cigUser.do?method=filter&filter=byLetter&letter=${c.character}" />
...
<a   href="/dfbs/cigarette/cigUser.do?method=updateUser&userId=<c:out value="${user.userId}"/>">[Edit User Information]</a>
<a   href="/dfbs/cigarette/cigUser.do?method=emailUserInfo&userId=<c:out value="${user.userId}"/>&companyId=<c:out value="${user.companyId}"/>">[Email New User Information]</a>
</c:if>
