...
<a   href="/dfbs/magazine/magazineUser.do?method=userList">
              [back to user list]</a>
  <div class="styledBox">
 <div id="mainContentFluid" align="left">

  
 <h2> Edit and Update Magazine Users</h2> 
   ...
   <tr>
    ...
    <tr>
     ...
     <html:text property="userLoginId" size="50" maxlength="50"/>
      <c:if test="${MAGAZINE_USER_ERROR.userLoginId == 'ERROR'}">
          <br/>
    ...
    <tr>
      ...
      <td>
       ...
       <c:if test="${MAGAZINE_USER_ERROR.userPassword == 'ERROR'}">
          <br/>
          <span class="error">* please specify login id</span> 
        </c:if> 
    </tr>
    <tr>
      ...
      <td>
       <html:text property="userPasswordExpiresDate" size="10" maxlength="10"/>
        ...
        <c:if test="${MAGAZINE_USER_ERROR.userPasswordExpiresDate == 'ERROR'}">
          <br/>
          <span class="error">* please specify login id</span> 
        </c:if> 
    </tr>
    ...
    <td>
      ...
      <c:if test="${MAGAZINE_UPDATE_USER_STATUS == 'Y'}">
