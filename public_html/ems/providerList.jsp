...
<a href="/idhs/dfbs/fireHouse/fireHouse.do">
            [back to start]  </a> </br></br>
...
<a title="<c:out value='${c.count}' /> owners" href="<c:out value='${url}' />"><c:out value='${c.character}' /></a>
 ...
 <a href="/dfbs/ems/provider.do?method=renewProvider&providerId=<c:out value="${provider.providerId}"/>">
  ...
  <p class="listingInfo">
   ...
   <a href="/dfbs/fireHouse/fireHouse.do?method=goToUpload&certNumber=<c:out value="${provider.providerCertNumber}"/>">
            [Upload Files for this Provider]  </a> 
  </div>
